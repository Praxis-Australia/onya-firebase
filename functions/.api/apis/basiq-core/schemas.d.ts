...
declare const GetAuthLink: {
  ...
  readonly response: {
    readonly '200': {
      readonly required: readonly ['expiresAt', 'id', 'mobile', 'type', 'userId'];
      readonly type: 'object';
      readonly properties: {
        readonly expiresAt: {
          readonly type: 'string';
...
declare const GetConsents: {
  ...
  readonly response: {
    readonly '200': {
      ...
      readonly required: readonly ['type', 'size', 'data'];
      readonly type: 'object';
      readonly properties: {
        readonly type: {
          readonly type: 'string';
        ...
        readonly size: {
          ...
          readonly description: 'Number of items in the list';
        ...
        readonly data: {
          ...
          readonly description: 'User consents data.';
        };
      };
      readonly description: 'List containing existing user consents.';
      readonly $schema: 'http://json-schema.org/draft-04/schema#';
    };
    readonly '400': {
      readonly required: readonly ['correlationId', 'data', 'type'];
    ...
    readonly allOf: readonly [
      {
        ...
        readonly properties: {
          readonly filter: {
            ...
            readonly $schema: 'http://json-schema.org/draft-04/schema#';
            readonly description: 'userId for the specific user you wish to retrieve events for. e.g user.id.eq(userId) Entity can be filtered with type for events for. e.g event.entity.eq(entity), event.type.eq(type)';
          };
        };
        ...
        readonly links: {
          ...
          readonly properties: {
            ...
            readonly connections: {
              ...
              readonly examples: readonly [
                'https://au-api.basiq.io/users/a3dgf4567a89/connections'
              ];
            };
            readonly self: {
              readonly type: 'string';
            ...
            readonly transactions: {
              ...
              readonly examples: readonly [
                'https://au-api.basiq.io/users/a3dgf4567a89/transactions'
              ];
            };
          };
                  ...
                  readonly links: {
                    ...
                    readonly properties: {
                      ...
                      readonly source: {
                        ...
                        readonly examples: readonly [
                          'https://au-api.basiq.io/users/ea3a81/connections/8fce3b'
                        ];
                      };
                    };
...
declare const PostAuthLink: {
  ...
  readonly response: {
    readonly '201': {
      readonly required: readonly ['expiresAt', 'mobile', 'type', 'userId'];
      readonly type: 'object';
      readonly properties: {
        readonly expiresAt: {
          readonly type: 'string';
  ...
  readonly response: {
    readonly '200': {
      ...
      readonly properties: {
        ...
        readonly expires_in: {
          readonly type: 'integer';
          readonly description: 'Expires in seconds';
          readonly format: 'int64';
